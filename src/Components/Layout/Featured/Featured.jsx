    ...
    <div className="container col-xxl-8 px-4 py-5">
      <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
        <div className="col-10 col-sm-8 col-lg-6">
          <img src={ImgFeature} className="d-block mx-lg-auto img-fluid rounded" alt="Bootstrap Themes" width={700} height={500} loading="lazy" />
        </div>
        <div className="col-lg-6">
          ...
          <div className="d-grid gap-2 d-md-flex justify-content-md-center">
            ...
            <Link to={"/registro"} className="btn btn-outline-secondary btn-lg px-4">Regístrate</Link>
          </div>
        </div>
      </div>
    </div>
